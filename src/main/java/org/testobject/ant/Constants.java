...
public class Constants {
	...
	public static final String PROPERTY_TEST_SUITE_ID = "testobject.testSuite.id";
	public static final String PROPERTY_TEAM = "testobject.team";
	public static final String PROPERTY_RUN_AS_PACKAGE = "testobject.runaspackage";
}
